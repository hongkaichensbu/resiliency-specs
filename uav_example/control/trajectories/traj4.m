function [desired_state] = traj4(t, qn)
...
%                 [pos, vel, ~] = tj_from_line([pos_1;30], [delivery_center_1;30], time_tol/3 * delivery_ts(1), t-time_tol/3);
                [pos, vel, ~] = tj_from_line([pos_1;30], [delivery_center_1+[-0.5;+2];30], time_tol/3 * delivery_ts(1), t-time_tol/3);
...
%                 [pos, vel, ~] = tj_from_line([delivery_center_1;30],[delivery_center_1;33], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(1));
                [pos, vel, ~] = tj_from_line([delivery_center_1+[-0.5;+2];30],[delivery_center_1;30], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(1));
...
%                 [pos, vel, ~] = tj_from_line([delivery_center_1;31],[delivery_center_2;20], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(4));
                [pos, vel, ~] = tj_from_line([0;0;30],[delivery_center_2;20], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(4));
...
%                 [pos, vel, ~] = tj_from_line([delivery_center_2;20],[delivery_center_2;23], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(5));
                [pos, vel, ~] = tj_from_line([delivery_center_2;20],[delivery_center_2+[2;-1];23], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(5));
...
%                 [pos, vel, ~] = tj_from_line([delivery_center_2;23],[delivery_center_2;20], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(6));
                [pos, vel, ~] = tj_from_line([delivery_center_2+[2;-1];23],[delivery_center_2;20], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(6));
            elseif t < time_tol/3 + time_tol/3 * delivery_ts(8)
                [pos, vel, ~] = tj_from_line([delivery_center_2;20],[delivery_center_2;20], time_tol/3 * delivery_ts(1),  t-time_tol/3-time_tol/3 * delivery_ts(7));
            else 
                [pos, vel, ~] = tj_from_line([delivery_center_2;20],[pos_2;20], time_tol/3 * delivery_ts(1), t-time_tol/3-time_tol/3 * delivery_ts(8));
            end
