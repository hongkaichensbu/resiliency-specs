...
%             Q.h_pos_des_hist = plot3(Q.h_3d, Q.des_state(1), Q.des_state(2), Q.des_state(3), 'b.');
            legend(Q.h_pos_hist, 'MAV Trajectory');
            building_3d(Q.h_3d);
...
%                 Q.motor(2,[1 3]), ...
%                 Q.motor(3,[1 3]), ...
%                 '-ko', 'MarkerFaceColor', Q.color, 'MarkerSize', 5,'HandleVisibility','off');
...
%                 Q.motor(2,[5 6]), ...
%                 Q.motor(3,[5 6]), ...
%                 'Color', Q.color, 'LineWidth', 2,'DisplayName',"MAV");
            Q.h_qz = scatter3(Q.h_3d, ...
                Q.motor(1,[5]), ...
                Q.motor(2,[5]), ...
                Q.motor(3,[5]), ...
                35,'filled','Color', Q.color, 'LineWidth', 2,'DisplayName',"MAV");
%             Q.h_qn = text(...
